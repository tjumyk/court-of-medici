...
(function() {
    ...
    if (fullScreenApi.supportsFullScreen) {
		...
		fullScreenApi.fullscreenchange = function(el,callback) {
            el.addEventListener(this.fullScreenEventName, callback, true);
        }
    }
    ...
    if (typeof jQuery != 'undefined') {
		...
		jQuery.fn.fullscreenchange = function(callback){
			...
			this.each(function() {
                if (fullScreenApi.supportsFullScreen) {
                    fullScreenApi.fullscreenchange(this,callback);
                }
            });
		}
    }
